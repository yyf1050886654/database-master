...
public class queryReservationPage extends JFrame implements ActionListener{
    ...
    public queryReservationPage(Customers customers) {
        super("查询预约菜单");        //JFrame的标题名称
        this.customers = customers;
        //创建组件
        jb1=new JButton("查看航班预约");
        jb2=new JButton("查看酒店预约");
        jb3=new JButton("查看大巴预约");
